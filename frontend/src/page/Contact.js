...
const Contact = () => {
  return (
    <section className="flex px-20 gap-2 flex-col text-xl overflow-hidden">
      <div className="bg-green-400 w-screen h-max flex p-4 text-center text-4xl italic shadow ">
        Contact Us
      </div>
